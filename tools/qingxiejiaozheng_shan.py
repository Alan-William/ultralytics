...
def tiltcorrection(imagepath, save_path):
...
if __name__ == "__main__":
    imagepath = 'C:/Users/xxa/Desktop/ultralytics/tools_testpic/qingxiejiaozheng/s (46).jpg'
    ...
    tiltcorrection(imagepath, save_path)